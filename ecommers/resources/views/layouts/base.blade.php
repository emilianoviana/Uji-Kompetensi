...
<head>
	...
	<title>Home</title>	
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/sociolla1.webp">
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="index.html" class="link-to-home"><img src="{{ asset('assets/images/sociolla.webp')}}" alt="mercado"></a>
						</div>
